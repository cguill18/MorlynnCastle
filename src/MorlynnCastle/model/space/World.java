...
public class World implements Serializable {
    ...
    public World() {
        ...
        //création des clefs
        Key key1 = new Key("small_key", keyDesc1,2,3);
        Key key2 = new Key("gold_key", keyDesc2,1,0);
        Key key3 = new Key("heavy_key", keyDesc3,0,0);
        Key key4 = new Key("big_key", keyDesc4,2,1);
        ...
        Container chest1 = new Container("wooden_chest", chestDesc1,2,3);
        ContainerWithLock chest2 = new ContainerWithLock("golden_chest", chestDesc2, key4,2,0);
        
        //descriptions d'objets divers
        String goldDesc1 = "There are gold_coins.";
        Gold gold1 = new Gold("gold_coins", goldDesc1,2,0);
        
        String scrollDesc1 = "This is an old tattered scroll. ";
        
        String scrollContent1 = "This scroll allows you to know the key to a door.";
        
        Scroll scroll1 = new Scroll("knock_scroll", scrollDesc1, scrollContent1,2,3);
        ...
        DoorWithLock dgt = new DoorWithLock(key2, goldenDoorDesc,3,0);
        DoorWithLock dtg = new DoorWithLock(key2, goldenDoorDesc,3,4);
        
        Door dgc = new Door(woodenDoorDesc,6,2);
        Door dcg = new Door(woodenDoorDesc,0,2);
        
        DoorWithLock dwgr = new DoorWithLock(key1, ironDoorDesc,3,0);
        DoorWithLock dgrw = new DoorWithLock(key1, ironDoorDesc,3,4);
        
        Door dgrc = new Door(woodenDoorDesc,0,2);
        ...
        Guard guard2 = new Guard("guard2", "A tall an dangerous guard, armed with a spike",4,1);
        interactionsGr.put(guard2.getName(), guard2);
        
        Guard guard3 = new Guard("guard3", "A dangerous guard, armed with a spike",2,3);
        interactionsT.put(guard3.getName(), guard3);
        
        Guard guard4 = new Guard("guard4", "A dangerous guard, armed with a spike",4,3);
        ...
        LeatherArmor leatherArmor = new LeatherArmor("leather_armor", leatherArmorDesc,4,1);
        ...
        ScaleMail scaleMail = new ScaleMail("scale_mail", scaleMailDesc,2,0);
        ...
        PlateArmor plateArmor = new PlateArmor("plate_armor", plateArmorDesc,2,1);

        Dagger dagger = new Dagger("dagger", "iron dagger",5,3);
        Sword sword = new Sword("sword", "iron sword",2,0);
        chest2.getContent().put(sword.getName(), sword);
        
        Greatsword greatsword = new Greatsword("greatsword", "iron greatsword",4,3);
